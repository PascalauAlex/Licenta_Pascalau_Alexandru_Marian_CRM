<template>
  ...
  >
    <div class="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
      <h1 class="text-3xl font-extrabold text-center text-gray-900 mb-8">Add Member</h1>
      ...
      <form class="space-y-5" @submit.prevent="handleSubmit">
        <div>
          <label class="block text-sm font-semibold text-gray-700 mb-1 leading-6">Last Name</label>
          <div>
            <input
              type="text"
              name="last_name"
        ...
        <div>
          <label class="block text-sm font-semibold text-gray-700 mb-1 leading-6">First Name</label>
          <div>
            <input
              type="text"
              name="first_name"
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await api.post('/api/v1/teams/add_member/',{
      username: email.value,
      first_name: first_name.value,
      last_name: last_name.value
    })
